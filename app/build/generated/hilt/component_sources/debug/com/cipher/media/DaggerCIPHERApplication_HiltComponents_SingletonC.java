...
public final class DaggerCIPHERApplication_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends CIPHERApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideContentResolverProvider = DoubleCheck.provider(new SwitchingProvider<ContentResolver>(singletonCImpl, 1));
      this.provideMediaRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<MediaRepository>(singletonCImpl, 0));
      this.provideEqualizerRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<EqualizerRepository>(singletonCImpl, 2));
      this.provideBillingManagerProvider = DoubleCheck.provider(new SwitchingProvider<BillingManager>(singletonCImpl, 3));
      this.provideBillingRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<BillingRepository>(singletonCImpl, 4));
      this.provideKeystoreManagerProvider = DoubleCheck.provider(new SwitchingProvider<KeystoreManager>(singletonCImpl, 7));
      this.provideEncryptedDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<EncryptedDatabase>(singletonCImpl, 6));
      this.provideIntruderLogDaoProvider = DoubleCheck.provider(new SwitchingProvider<IntruderLogDao>(singletonCImpl, 5));
      this.provideVaultDaoProvider = DoubleCheck.provider(new SwitchingProvider<VaultDao>(singletonCImpl, 8));
      this.provideCryptoUtilProvider = DoubleCheck.provider(new SwitchingProvider<CryptoUtil>(singletonCImpl, 10));
      this.provideVaultEncryptionManagerProvider = DoubleCheck.provider(new SwitchingProvider<VaultEncryptionManager>(singletonCImpl, 9));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.cipher.media.data.repository.MediaRepository 
          ...
          case 1: // android.content.ContentResolver 
          ...
          case 2: // com.cipher.media.data.repository.EqualizerRepository 
          ...
          case 3: // com.cipher.media.billing.BillingManager 
          ...
          case 4: // com.cipher.media.billing.BillingRepository 
          ...
          case 5: // com.cipher.media.data.local.IntruderLogDao 
          ...
          case 6: // com.cipher.media.data.local.EncryptedDatabase 
          ...
          case 10: // com.cipher.media.data.encryption.CryptoUtil 
