...
public final class VaultSyncEngine_Factory implements Factory<VaultSyncEngine> {
  ...
  public VaultSyncEngine_Factory(Provider<CloudinaryManager> cloudinaryManagerProvider,
  ...
  public VaultSyncEngine get() {
    return newInstance(cloudinaryManagerProvider.get(), metadataRepositoryProvider.get(), vaultDaoProvider.get(), billingRepositoryProvider.get());
  }

  public static VaultSyncEngine_Factory create(
      Provider<CloudinaryManager> cloudinaryManagerProvider,
      Provider<CloudMetadataRepository> metadataRepositoryProvider,
      Provider<VaultDao> vaultDaoProvider, Provider<BillingRepository> billingRepositoryProvider) {
    return new VaultSyncEngine_Factory(cloudinaryManagerProvider, metadataRepositoryProvider, vaultDaoProvider, billingRepositoryProvider);
  }

  public static VaultSyncEngine newInstance(CloudinaryManager cloudinaryManager,
      CloudMetadataRepository metadataRepository, VaultDao vaultDao,
      BillingRepository billingRepository) {
    return new VaultSyncEngine(cloudinaryManager, metadataRepository, vaultDao, billingRepository);
  }
}
